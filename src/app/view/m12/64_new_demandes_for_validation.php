...
<div align="center" style="margin-top:50px;">
	...
	<div align="left" class="action_button_list">
		<ul>
			<?php
				...
				echo '<li><a class="buttonLink fancybox fancybox.iframe action_link group_action_link" href="'.Systeme::sm_path('63_validateDemande_form').'">Valider</a></li>';	
			?>			
		</ul>
	</div>
	<table border="0" id="dataTable" class="display datatable">
        ...
        <?php
			  ...
			  $demandes = Demande::notViewedUserDemandes($intervenant->id());
