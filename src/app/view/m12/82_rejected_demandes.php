...
<div align="center" style="margin-top:50px;">
	...
	<div align="left" class="action_button_list">
		<ul>
			<?php
				...
				echo '<li><a class="buttonLink fancybox fancybox.iframe action_link single_action_link noAction" href="'.Systeme::sm_path('82_disableDemandes_form').'">Désactiver</a></li>';	
	...
	<table border="0" id="dataTable" class="display datatable">
        ...
        <?php
			  ...
			  $demandes = Demande::inStates(array(REJECTED));
			  			  
			  foreach($demandes as $str)
			  {
				echo '<tr class="line">';
					echo '<td><input type="checkbox" name="dossier_'.$str->id().'" value="'.$str->id().'" '.($str->validState()==0?'noAction="noAction"':'').' /></td>';
					echo '<td>'.(++$i).'</td>';
