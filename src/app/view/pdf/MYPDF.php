<?php
require_once("../../requirements_alt.php");
//============================================================+
...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->setXY(40,16);
        $this->Cell(0, 15, 'De l\'Energie', 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $this->setXY(40,20);
        ...
        $this->setXY(150,12);
        $this->Cell(0, 15, 'Tél: +229 21 31 29 07 - Fax: +229 21 31 35 46', 0, false, 'R', 0, '', 0, false, 'M', 'M');
        $this->setXY(150,16);
        $this->Cell(0, 15, '04 BP: 1412 COTONOU - BENIN', 0, false, 'R', 0, '', 0, false, 'M', 'M');
        $this->setXY(150,20);
        $this->Cell(0, 15, 'www.energie.gouv.bj', 0, false, 'R', 0, '', 0, false, 'M', 'M');
    ...
    public function Footer() {
        ...
        $this->SetFont('helvetica', 'I', 8);
        $this->Cell($width,10, 'Page '.$this->getAliasNumPage().'/'.$this->getAliasNbPages().' generated by pmvc 16.03.01 @ '.date('d/m/Y'), 0, false, 'C', 0, '', 0, false, 'T', 'M');
    }
}
