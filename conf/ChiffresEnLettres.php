...
#Fonction de conversion appel&eacute;e dans la feuille principale
...
#suppression des z&eacute;ros qui pr&eacute;c&eacute;deraient la saisie
$nb=strlen($nombre);
for ($i=0;$i<=$nb;)
{
...
#echo $nombre;
#$this->SupZero($nombre);
#le nombre de caract que comporte le nombre saisi de sa forme sans espace et sans 0 au d&eacute;but
$nb=strlen($nombre);
#echo $nb.'<br/ >';
...
#suppression des z&eacute;ros qui pr&eacute;c&eacute;deraient le $reste
$nb=strlen($reste);
for ($i=0;$i<=$nb;)
{
...
{
#Gestion des milles
#suppression des z&eacute;ros qui pr&eacute;c&eacute;deraient les milles dans $mille
$nb=strlen($mille);
for ($i=0;$i<=$nb;)
{
...
#Gestion des cents
#suppression des z&eacute;ros qui pr&eacute;c&eacute;deraient les cents dans $cent
$nb=strlen($cent);
for ($i=0;$i<=$nb;)
{
...
elseif ($unite==0 and $dizaine<>0)
{
#recup&eacute;ration des dizaines
